...
exports.parseExec = exports.getHardhatBaseProvider = exports.getVMFromBaseProvider = void 0;
async function getVMFromBaseProvider(provider) {
    return provider._node._vm;
}
exports.getVMFromBaseProvider = getVMFromBaseProvider;
/**
...
const getHardhatBaseProvider = async (runtime) => {
    ...
    while (provider._wrapped !== undefined) {
        ...
        if (currentLoopIterations > maxLoopIterations) {
            throw new Error(`unable to find base hardhat provider. are you sure you're running locally?`);
        }
    }
