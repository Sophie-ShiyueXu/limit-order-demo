...
export interface USDCLikePermitMockInterface extends Interface {
    getFunction(nameOrSignature: "DOMAIN_SEPARATOR" | "PERMIT_TYPEHASH" | "allowance" | "approve" | "balanceOf" | "decimals" | "eip712Domain" | "name" | "nonces" | "permit(address,address,uint256,uint256,bytes)" | "permit(address,address,uint256,uint256,uint8,bytes32,bytes32)" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
export interface USDCLikePermitMock extends BaseContract {
    connect(runner?: ContractRunner | null): USDCLikePermitMock;
    waitForDeployment(): Promise<this>;
    interface: USDCLikePermitMockInterface;
