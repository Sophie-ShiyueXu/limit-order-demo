...
export interface BySigTraitsInterface extends Interface {
}
export interface BySigTraits extends BaseContract {
    connect(runner?: ContractRunner | null): BySigTraits;
    waitForDeployment(): Promise<this>;
    interface: BySigTraitsInterface;
