...
exports.DaiLikePermit = exports.Permit = exports.EIP712Domain = exports.PERMIT2_ADDRESS_ZKSYNC = exports.defaultDeadlinePermit2 = exports.defaultDeadline = exports.TypedDataVersion = void 0;
...
exports.PERMIT2_ADDRESS_ZKSYNC = '0x0000000000225e31D15943971F47aD3022F714Fa';
...
function permit2Address(chainId) {
    switch (chainId) {
        ...
        case 260: // zksync fork network
            return exports.PERMIT2_ADDRESS_ZKSYNC;
        default:
            return permit2_sdk_1.PERMIT2_ADDRESS;
    }
}
/**
 * @category permit
 ...
 */
async function permit2Contract(chainId) {
    const permit2addr = permit2Address(chainId);
    if ((await hardhat_1.ethers.provider.getCode(permit2addr)) === '0x') {
        await hardhat_1.ethers.provider.send('hardhat_setCode', [permit2addr, permit2_json_1.bytecode]);
    }
    return hardhat_1.ethers.getContractAt('IPermit2', permit2addr);
}
/**
 * @category permit
