...
const jestSnapshotPlugin = (optionalConfig) => {
    ...
    const rootDir = packageJson.done
        ? process.cwd()
        : node_path_1.default.dirname(packageJson.filename);
    ...
    return function (chai, utils) {
        ...
        beforeEach(function () {
            if (this.currentTest)
                _manager.setContext(this.currentTest, chai);
        });
        after(function () {
            _manager.saveSnap();
...
const initSnapshotManager = node_util_1.default.deprecate(jestSnapshotPlugin(), "chai.use(initSnapshotManager) was deprecated. use chai.use(jestSnapshotPlugin()) instead.", constants_1.DEPRECATED_CODE_INIT_SNAPSHOT_MANAGER);
